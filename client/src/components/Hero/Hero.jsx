        ...
        <div className="flex flex-col justify-center py-14 md:py-0 relative z-20">
          <div className="text-center md:text-left space-y-10 lg:max-w-[400px]">
            <motion.h1
              ...
              initial="initial"
              animate="animate"
              className="text-3xl lg:text-5xl font-bold !leading-snug font-serifDisplay text-black"
            >
              Personalized
              <span className="text-secondary"> {" "}Learning</span> for every Unique learner
            </motion.h1>
            <motion.div
              variants={FadeUp(0.8)}
              initial="initial"
